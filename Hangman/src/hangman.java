...
public class hangman {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            String[] randomWords = {"red", "blue", "bird", "song", "all", "day", "long", "sing", "water", "earth", "fire", "wind", "heart", "planet"};
            int randomWordIndex = random.nextInt(14);
            String word = randomWords[randomWordIndex];

            int charLen = randomWords[randomWordIndex].length();
